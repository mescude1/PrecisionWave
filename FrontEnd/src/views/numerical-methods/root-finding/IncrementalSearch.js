...
import IncrementalSearchTheory from "src/views/numerical-methods/theory/incremental_search_theory";
...
const IncrementalSearch = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://precision-wave.azuloso.me/methods/incremental-search', formData, {
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <CCollapse visible={visible}>
              <IncrementalSearchTheory></IncrementalSearchTheory>
            </CCollapse>
          </CCardBody>
        </CCard>
      </CCol>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <form onSubmit={handleSubmit}>
              ...
              <CInputGroup className="mb-3">
                <CInputGroupText id="h">h</CInputGroupText>
                <CFormInput
                  placeholder="Step"
                  aria-label="step"
