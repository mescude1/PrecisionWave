    ...
    <CRow>
      <CCol xs={6}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <h2>Bisection</h2>
            <p>The <strong>bisection method</strong> is a numerical technique for finding roots that refines an interval
            ...
            <ol>
              ...
              <ul>
                <li>If <InlineMath math=" f(c) = 0 "/>, then <InlineMath math=" c "/> is the root, and the method stops.
                </li>
