        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <ol>
              ...
              <ul>
                <li>Start with two initial guesses, <InlineMath math=" x_0 " /> and <InlineMath math=" x_1 " />, that are reasonably close to the expected
                  root.
                </li>
              </ul>
              ...
              <ul>
                <li> After calculating <InlineMath math=" x_{n + 1} " />, check if the difference <InlineMath math=" |x_{n + 1} - x_n| " /> is smaller than
                  a specified tolerance level. If so, stop and take <InlineMath math=" x_{n + 1} " /> as the approximate root.
                </li>
                <li> If not, set <InlineMath math=" x_{n - 1} = x_n " /> and <InlineMath math=" x_n = x_{n + 1} " />, and repeat the iteration.</li>
              </ul>
            ...
            <p>Suppose we want to find a root of the function <InlineMath math=" f(x) = x^2 - 4 " />, which has roots at <InlineMath math=" x = 2 " /> and
              <InlineMath math=" x = -2 " />.</p>
            <ol>
              <li>Choose Initial Approximations**: Let’s start with <InlineMath math=" x_0 = 3 " /> and <InlineMath math=" x_1 = 2.5 " />.</li>
              ...
              :
              <ul>
                <li> Continue iterating until the difference between <InlineMath math=" x_n " /> and <InlineMath math=" x_{n + 1} " /> is within the
                  tolerance level. In this example, the method will quickly converge to the root at <InlineMath math=" x = 2 " /> within a
                  few more iterations.
                </li>
              </ul>
            </ol>
