...
import CroutTheory from "src/views/numerical-methods/theory/crout_theory";
...
const Crout = () => {
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post('https://precision-wave.azuloso.me/methods/crout', { matrix, vector, pivot });
